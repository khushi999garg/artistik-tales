...
const Home = () => {
  ...
  return (
    <section id="header" className="home-container Heading">
      <Helmet>
        <title>आrtistik टales</title>
        <meta property="og:title" content="आrtistik टales" />
      </Helmet>
      <Navbar/>
      <div className="home-container2">
        <h1>आrtistik <br></br>टales</h1>
        <img
          alt="image"
          src={logo}
          className="home-image2"
        />
        <span>Artistik Tales was started over 2 years ago with the vision to infuse poetry with art. The artist believes each painting tells a story and unfolds a perception.</span>
      </div>
      <div className='home-container5'>
        <img src={Image5} alt='Image' className='image1'></img>
        <h6>Hi, My Name Is Ravneet Kaur</h6>
        <p className='home-text16'>I have been honing my painting skills in various mediums, incluiding oil, charcoal, and acrylics, for over a decade. My work has been featured in multiple exhibitions.</p>
      </div>
      ...
      <footer className="home-footer">
        ...
        <div className="home-container4">
          ...
          <div className="home-icon-group2">
            ...
            <a href='https://www.linkedin.com/in/ravneet-kaur-23a9101a5/' to='_blank' rel='noopener, noreferrer'>
